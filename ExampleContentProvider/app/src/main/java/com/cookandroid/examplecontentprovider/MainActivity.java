package com.cookandroid.examplecontentprovider;
...
public class MainActivity extends AppCompatActivity {
    ...
    public String getCallHistory() {
        ...
        Cursor c = getContentResolver().query(CallLog.Calls.CONTENT_URI, callSet, null, null, null, null);
        ...
        // Column별로 저장된 데이터 형식이 다르고 이에 따라서 데이터 포맷도 달라진다.
        do {
