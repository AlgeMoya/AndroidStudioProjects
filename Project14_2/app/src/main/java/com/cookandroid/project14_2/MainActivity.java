                ...
                if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                    ...
                    switch (plug) {
                        case 0:
                            ...
                            Toast.makeText(getApplicationContext(), "전원 연결 : 안 됨", Toast.LENGTH_SHORT).show();
                            break;
                        case BatteryManager.BATTERY_PLUGGED_AC:
                            edtBattery.append("전원 연결 : 어댑터 연결됨");
                            Toast.makeText(getApplicationContext(), "전원 연결 : 어댑터 연결됨", Toast.LENGTH_SHORT).show();
                            break;
                        case BatteryManager.BATTERY_PLUGGED_USB:
                            edtBattery.append("전원 연결 : USB 연결됨");
                            Toast.makeText(getApplicationContext(), "전원 연결 : USB 연결됨", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }
            }
